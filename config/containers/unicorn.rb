...
# Bind Unicorn should write its log files
listen "0.0.0.0:3000"
...
# A new Rails app just need one. You would scale this
# higher in the future once your app starts getting traffic.
# See https://unicorn.bogomips.org/TUNING.html
worker_processes 1

# Maker sure we use the correct Gemfile on restarts
before_exec do |server|
	ENV['BUNDLE_GEMFILE'] = "#{app_path}/Gemfile"
end

# Speeds up your workers.
# See https://unicorn.bogoips.org/TUNING.html
preload_app true
